    ...
    <>
      ...
      <main className="subpage">
        <section className="subhero">
          ...
          <p>
            Prove an age threshold, nationality match, or sanctions-clear result to a specific app or contract. You get
            a portable signed true/false artifact—without publishing the passport data behind it.
          </p>
        </section>
