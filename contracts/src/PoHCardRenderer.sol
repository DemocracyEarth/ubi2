...
contract PoHCardRenderer {
    ...
    string private constant _A =
        '<svg width="640" height="900" viewBox="0 0 640 900" xmlns="http://www.w3.org/2000/svg" role="img"><title>Proof of Humanity</title>\n'
        '<defs>\n'
    ...
    string private constant _E =
        unicode'</text><circle cx="558" cy="726" r="13" fill="none" stroke="url(#ok)" stroke-width="1.6"/><path d="M552 726 l4 4 l8 -8.5" fill="none" stroke="url(#ok)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>\n'
