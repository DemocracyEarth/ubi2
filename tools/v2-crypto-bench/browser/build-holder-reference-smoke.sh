...
profile_wasm="$repo_dir/fixtures/v2-production-crypto/holder-profile-synthetic-v1.wasm"
...
actual_profile_wasm_sha256="$(shasum -a 256 "$profile_wasm" | awk '{print $1}')"
...
cp "$profile_wasm" "$dist_dir/ubi2_v2_crypto_bench_bg.wasm"
