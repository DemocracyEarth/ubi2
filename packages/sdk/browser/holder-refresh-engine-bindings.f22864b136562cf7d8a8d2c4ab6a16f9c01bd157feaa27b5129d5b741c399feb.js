 ...
 * @returns {string}
 */
export function buildPackedStatusPath(source, status_id) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.buildPackedStatusPath(ptr0, len0, status_id);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function validatePackedStatusSnapshot(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validatePackedStatusSnapshot(ptr0, len0);
    if (ret[1]) {
...
export function verifyProductionVaultPayload(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.verifyProductionVaultPayload(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {number}
 */
export function wasmLinearMemoryBytes() {
    const ret = wasm.wasmLinearMemoryBytes();
    return ret >>> 0;
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_byteLength_ec344df267db405f: function(arg0) {
