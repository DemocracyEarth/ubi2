...
const client = createZkHolderProfileBrowserClient({
  workerUrl: new URL("https://holder.invalid/assets/profile-worker.451d599b.js"),
  WorkerConstructor: TestWorker,
});
await client.prove(request());
assert.equal(createdUrl?.href, "https://holder.invalid/assets/profile-worker.451d599b.js");
